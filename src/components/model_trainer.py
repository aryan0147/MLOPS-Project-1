...
# model = RandomForestClassifier(
#     n_estimators=self.model_trainer_config.MODEL_TRAINER["N_ESTIMATORS"],
#     min_samples_split=self.model_trainer_config.MODEL_TRAINER["MIN_SAMPLES_SPLIT"],
#     min_samples_leaf=self.model_trainer_config.MODEL_TRAINER["MIN_SAMPLES_LEAF"],
#     max_depth=self.model_trainer_config.MIN_SAMPLES_SPLIT["MAX_DEPTH"],
#     criterion=self.model_trainer_config.MIN_SAMPLES_SPLIT["CRITERION"],
#     random_state=self.model_trainer_config.MIN_SAMPLES_SPLIT["RANDOM_STATE"],
# )
